...
public class InventorySerializer {
    ...
    public static void restoreFromDataContainer(PlayerInventory inventory, PersistentDataContainer dataContainer) throws IOException {
        ...
        ItemStack offhand = InventorySerializer.itemStackArrayFromBase64(dataContainer.get(Main.key("inventory_offhand"), PersistentDataType.STRING))[0];
        inventory.setContents(recovery.getContents());
